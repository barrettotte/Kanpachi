    ...
    class Program{
        ...
        static void Main(string[] args){
            ...
            Parser.Default.ParseArguments<ConfigCmd, ExecCmd, IfsCmd, ProfileCmd, QsysCmd>(args)
                .WithParsed<ConfigCmd>(ParseConfigCmd)
                .WithParsed<ExecCmd>(ParseExecCmd)
                .WithParsed<IfsCmd>(ParseIfsCmd)
                .WithParsed<ProfileCmd>(ParseProfileCmd)
                .WithParsed<QsysCmd>(ParseQsysCmd)
            ;
        }
    }
}